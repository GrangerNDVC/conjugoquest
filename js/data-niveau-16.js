const NIVEAU_16_DATA = {
  ...
  "attaques": [
    ...
    { "id": 1, "incantation": "Il faut que je {VERBE} ce démon !", "verbe": "vaincre", "personne": "je", "temps": "Subjonctif présent", "solution": "vainque", "difficulte": "CRE" },
    { "id": 2, "incantation": "Bien que tu {VERBE} l'épreuve...", "verbe": "réussir", "personne": "tu", "temps": "Subjonctif présent", "solution": "réussisses", "difficulte": "2ème groupe" },
    { "id": 3, "incantation": "Pour que nous {VERBE} à la cour...", "verbe": "venir", "personne": "nous", "temps": "Subjonctif présent", "solution": "venions", "difficulte": "Venir" },
    { "id": 4, "incantation": "Avant que vous {VERBE} du royaume...", "verbe": "partir", "personne": "vous", "temps": "Subjonctif présent", "solution": "partiez", "difficulte": "Partir" },
    { "id": 5, "incantation": "Quoique ils {VERBE} la foi...", "verbe": "avoir", "personne": "ils", "temps": "Subjonctif présent", "solution": "aient", "difficulte": "Avoir" },
    { "id": 6, "incantation": "Il faut que je {VERBE} digne !", "verbe": "être", "personne": "je", "temps": "Subjonctif présent", "solution": "sois", "difficulte": "Être" },
    { "id": 7, "incantation": "Bien que tu {VERBE} au combat...", "verbe": "aller", "personne": "tu", "temps": "Subjonctif présent", "solution": "ailles", "difficulte": "Aller" },
    { "id": 8, "incantation": "Pour qu'elle {VERBE} la leçon...", "verbe": "comprendre", "personne": "elle", "temps": "Subjonctif présent", "solution": "comprenne", "difficulte": "Prendre" },
    { "id": 9, "incantation": "Avant que nous {VERBE} l'impensable...", "verbe": "faire", "personne": "nous", "temps": "Subjonctif présent", "solution": "fassions", "difficulte": "Faire" },
    { "id": 10, "incantation": "Quoique vous {VERBE} tout...", "verbe": "pouvoir", "personne": "vous", "temps": "Subjonctif présent", "solution": "puissiez", "difficulte": "Pouvoir" },
    ...
    { "id": 12, "incantation": "Pourvu qu'il {VERBE} nous rejoindre !", "verbe": "vouloir", "personne": "il", "temps": "Subjonctif présent", "solution": "veuille", "difficulte": "Vouloir" },
    ...
    { "id": 15, "incantation": "Quoique les mages {VERBE} l'avenir...", "verbe": "dire", "personne": "ils", "temps": "Subjonctif présent", "solution": "disent", "difficulte": "Dire" },
    ...
    { "id": 21, "incantation": "Il faut que nous {VERBE} les lois !", "verbe": "changer", "personne": "nous", "temps": "Subjonctif présent", "solution": "changions", "difficulte": "GER" },
    ...
    // --- VERBES EN -DRE ---
    { "id": 26, "incantation": "Il faut que tu {VERBE} au combat !", "verbe": "répondre", "personne": "tu", "temps": "Subjonctif présent", "solution": "répondes", "difficulte": "DRE" },
    { "id": 27, "incantation": "Bien qu'ils {VERBE} la lumière...", "verbe": "répandre", "personne": "ils", "temps": "Subjonctif présent", "solution": "répandent", "difficulte": "DRE" },
    { "id": 28, "incantation": "Pour que nous {VERBE} la tempête...", "verbe": "attendre", "personne": "nous", "temps": "Subjonctif présent", "solution": "attendions", "difficulte": "DRE" },
    { "id": 29, "incantation": "Avant que vous {VERBE} l'épée...", "verbe": "tendre", "personne": "vous", "temps": "Subjonctif présent", "solution": "tendiez", "difficulte": "DRE" },
    { "id": 30, "incantation": "Quoique le vent {VERBE} les arbres...", "verbe": "tordre", "personne": "il", "temps": "Subjonctif présent", "solution": "torde", "difficulte": "DRE" }
  ],
  "defenses": [
