const NIVEAU_18_DATA = {
  ...
  "defenses": [
    { "id": 1, "question": "Quelle est la terminaison de la 3e personne du singulier au subjonctif imparfait ?", "choix": ["-ât, -ît, -ût", "-ait, -it, -ut", "-a, -i, -u", "-asse, -isse, -usse"], "solution": 0 },
    { "id": 2, "question": "Sur quel temps de l'indicatif se forme le subjonctif imparfait ?", "choix": ["Le passé simple (2e pers. sing.)", "Le futur simple", "L'imparfait", "Le présent"], "solution": 0 },
    { "id": 3, "question": "Subjonctif imparfait de 'être' à la 1re personne du singulier :", "choix": ["je fusse", "je sois", "je serais", "j'étais"], "solution": 0 },
    { "id": 4, "question": "Subjonctif imparfait de 'avoir' à la 3e personne du pluriel :", "choix": ["ils auraient", "ils aient", "ils avaient", "ils eussent"], "solution": 3 },
    { "id": 5, "question": "Subjonctif imparfait de 'faire' à la 1re personne du pluriel :", "choix": ["nous fissions", "nous fassions", "nous faisions", "nous ferions"], "solution": 0 },
    { "id": 6, "question": "Subjonctif imparfait de 'pouvoir' à la 2e personne du singulier :", "choix": ["tu pouvais", "tu pusses", "tu puisses", "tu pourrais"], "solution": 1 },
    { "id": 7, "question": "Quelle est la valeur principale du subjonctif imparfait en français moderne ?", "choix": ["Donner un ordre", "Usage littéraire, concordance des temps au passé", "Parler au futur", "Exprimer un souhait présent"], "solution": 1 },
    { "id": 8, "question": "Subjonctif imparfait de 'venir' à la 2e personne du pluriel :", "choix": ["vous veniez", "vous vinssiez", "vous vîntes", "vous viendriez"], "solution": 1 },
    { "id": 9, "question": "Dans 'Il fallait que je ______ (partir)', quelle forme est correcte au subjonctif imparfait ?", "choix": ["partirais", "partisse", "parte", "partais"], "solution": 1 },
    { "id": 10, "question": "Subjonctif imparfait de 'savoir' à la 3e personne du singulier :", "choix": ["il sût", "il saurait", "il sache", "il savait"], "solution": 0 },
    { "id": 11, "question": "Quel est le radical du subjonctif imparfait pour les verbes comme 'tenir' ?", "choix": ["tienn-", "tin-", "tiendr-", "ten-"], "solution": 1 },
    { "id": 12, "question": "Subjonctif imparfait de 'vouloir' à la 1re personne du pluriel :", "choix": ["nous veuillions", "nous voudrions", "nous voulions", "nous voulussions"], "solution": 3 },
    { "id": 13, "question": "À quoi reconnaît-on un subjonctif imparfait ?", "choix": ["Aux terminaisons -ai, -as, -a, -âmes, -âtes, -èrent", "Aux terminaisons -sse, -sses, -^t, -ssions, -ssiez, -ssent", "Aux terminaisons -ais, -ais, -ait, -ions, -iez, -aient", "Au radical de l'infinitif"], "solution": 1 },
    { "id": 14, "question": "Subjonctif imparfait de 'prendre' à la 3e personne du pluriel :", "choix": ["ils prendraient", "ils prenaient", "ils prissent", "ils prennent"], "solution": 2 },
    { "id": 15, "question": "Dans un récit au passé, après 'bien que', on utilise :", "choix": ["le subjonctif présent", "le subjonctif imparfait", "le conditionnel", "l'indicatif imparfait"], "solution": 1 },
    { "id": 16, "question": "Subjonctif imparfait de 'devoir' à la 2e personne du singulier :", "choix": ["tu dusses", "tu devais", "tu devrais", "tu doives"], "solution": 0 },
    { "id": 17, "question": "Quel temps composé correspond au subjonctif imparfait ?", "choix": ["Conditionnel passé", "Subjonctif plus-que-parfait", "Subjonctif passé", "Plus-que-parfait"], "solution": 1 },
    { "id": 18, "question": "Subjonctif imparfait de 'recevoir' à la 1re personne du singulier :", "choix": ["je recevrais", "je reçoive", "je reçusse", "je recevais"], "solution": 2 },
    { "id": 19, "question": "Dans la phrase 'Il eût fallu que tu ______', quel temps est 'eût' ?", "choix": ["Subjonctif plus-que-parfait", "Subjonctif imparfait", "Conditionnel passé", "Passé antérieur"], "solution": 0 },
    { "id": 20, "question": "Subjonctif imparfait de 'craindre' à la 3e personne du singulier :", "choix": ["il craignît", "il craignait", "il craint", "il craindrait"], "solution": 0 },
  ]
};